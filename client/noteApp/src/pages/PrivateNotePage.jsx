...
const PrivateNotePage = () => {
  ...
  const fetchNotes = async () => {
    ...
    try {
      ...
      // Gizli notları filtreleyin
      const privateNotes = data.filter((note) => note.status === "closed");
      setNotes(privateNotes); // Filtrelenmiş notları duruma kaydet
    } catch (error) {
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-4 bg-gray-200">
          ...
          <p className="flex items-center justify-center mt-4 font-havlucu text-gray-600">
            Burada gizli notlarınızı görebilirsiniz.
          </p>
          <div className="mt-8">
